...
public class Constants {
    ...
    public final static String       BIZ_EVENT_TOPIC_CLEAN_AFTER_INVOKE_BIZ_STOP       = "CLEAN-AFTER-INVOKE-BIZ-STOP";
    ...
    public final static String       PLUGIN_EVENT_TOPIC_CLEAN_AFTER_INVOKE_PLUGIN_STOP = "CLEAN-AFTER-INVOKE-PLUGIN-STOP";
